<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="System_SMSTemplate_View.aspx.cs" Inherits="Web.main_system.program.System_SMSTemplate_View" %>

<html>
	<head>
		<title>短信平台_短信模版</title>
		<%--/* ＊＊＊＊＊程序信息注释＊＊＊＊＊＊＊＊
          程序名：短信平台_短信模版程序
          程序描述：短信模版程序
         ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊*/--%>
						...
						<td>
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
								<tr>
									...
									<td class="title2" nowrap>短信模版管理</td>
									<td width="10"><img height="25" src="../../images/page/table_tit_r2.gif" width="10"></td>

									<td class="tdimages" width="99%" align="right">

                                    <%--标题：<asp:TextBox id="txtTitle" runat="server" Width="100px" >&nbsp;&nbsp;</asp:TextBox>&nbsp;&nbsp;
                                    内容：<asp:TextBox id="txtCount" runat="server" Width="100px" >&nbsp;&nbsp;</asp:TextBox>&nbsp;&nbsp;
                                    操作员：<asp:DropDownList id="ddlUserID" runat="server" DESIGNTIMEDRAGDROP="70"></asp:DropDownList>&nbsp;&nbsp;
                                    
										<asp:Button id="btnCha" runat="server" Text="查  询" CssClass="button"
                                         onclick="btnCha_Click" ></asp:Button>&nbsp;&nbsp;&nbsp;--%>
                                        <asp:Button id="btnAdd" runat="server" Text="新  增" 
							...
							<table class="tableclass2" cellspacing="0" cellpadding="0" width="100%" border="0">
								...
								<tr>
									<td><asp:datagrid id="MyDataGrid" runat="server" gridlines="Horizontal" 
											...
											<Columns >
												<asp:TemplateColumn Visible="false" HeaderText="行号">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.idno") %>' ID="Label5">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
                                                <asp:TemplateColumn Visible="false" HeaderText="模版ID">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Id") %>' CausesValidation="False" ID="Linkbutton1">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="模版名称">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TemplateName") %>' CausesValidation="False" ID="Linkbutton2">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="模版内容">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TemplateContent") %>' CausesValidation="False" ID="Linkbutton3">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
