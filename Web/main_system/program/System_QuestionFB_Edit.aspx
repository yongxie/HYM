<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="System_QuestionFB_Edit.aspx.cs" Inherits="Web.main_system.program.System_QuestionFB_Edit" %>
								...
								<td>
									<table class="tableclass" id="SaleManagerList_Table" cellspacing="0" cellpadding="0" width="100%" align="center">
										<tr>
											...
											<td colspan="3">&nbsp;
												<asp:textbox id="txtQuesName" runat="server"  maxlength="100" Width="500px"></asp:textbox><font color="red">*
												<asp:requiredfieldvalidator id="vrftxtGoodsID" runat="server" errormessage="系统提示：问题标题不能为空" display="None" controltovalidate="txtQuesName"></asp:requiredfieldvalidator></font></td>
											
										</tr><tr><td>&nbsp;</td></tr>
                                        <tr id="showtr" runat="server" visible="false">
                                            <td>
                                                &nbsp;
                                            </td>
                                            <td>
										...
										<tr>
											...
											<td colspan="3">&nbsp;
												<asp:textbox id="txtQuesContent" runat="server" width="500px" rows="10" textmode="MultiLine"></asp:textbox>
												<asp:regularexpressionvalidator id="vretxtDesc" runat="server" 
                                                    validationexpression="(.|\n){0,1000}" errormessage="系统提示：不能超过1000个字符" 
                                                    display="None" controltovalidate="txtQuesContent"></asp:regularexpressionvalidator>
                                                <br />
                                                <br />
                                            </td>
										</tr>
                                        <tr><td align="right">&nbsp;</td><td>
                                            &nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click"><font color="red">更新问题</font></asp:LinkButton></td></tr>
                                        <tr><td>&nbsp;</td></tr>
										<tr id="trNew" runat="server" visible="false">
											<td  align="right">&nbsp;</td>
											<td colspan="3">&nbsp;
												<asp:textbox id="txtNewContent" runat="server" width="500px" rows="10" textmode="MultiLine"></asp:textbox>
												<asp:regularexpressionvalidator id="vretxtNew" runat="server" 
                                                    validationexpression="(.|\n){0,1000}" errormessage="系统提示：不能超过1000个字符" 
                                                    display="None" controltovalidate="txtNewContent"></asp:regularexpressionvalidator>
                                                <br />
                                                <br />
                                            </td>
										</tr>
                                        ...
                                        <tr><td>&nbsp;</td></tr>
										<tr id="trAnwser2" runat="server" visible="false">
											<td  align="right">回 复：</td>
											<td colspan="3">&nbsp;
												<asp:textbox id="txtAnwser" ReadOnly="true" runat="server" width="500px" rows="20" textmode="MultiLine"></asp:textbox>
                                                <br />
                                                <br />
                                            </td>
										</tr>
