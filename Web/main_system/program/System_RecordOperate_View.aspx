<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="System_RecordOperate_View.aspx.cs" Inherits="Web.main_system.program.System_RecordOperate_View" %>

<HTML>
	<HEAD>
		<title>系统功能_系统日志查询</title>
		<%--/* ＊＊＊＊＊程序信息注释＊＊＊＊＊＊＊＊
          程序名：系统功能_系统日志查询程序
          程序描述：系统功能系统日志查询程序
         ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊*/--%>
						...
						<td>
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
								<tr>
									...
									<td class="title2" nowrap>系统日志查询浏览</td>
									<td width="10"><img height="25" src="../../images/page/table_tit_r2.gif" width="10"></td>
									<td class="tdimages" width="99%" align="right">操作员：<asp:DropDownList id="ddlUserID" runat="server" DESIGNTIMEDRAGDROP="70"></asp:DropDownList>
								...
								<tr>
									<td><asp:datagrid id="MyDataGrid" runat="server" gridlines="Horizontal" 
											...
											<Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="操作员代码">
													<ItemTemplate>
                                                        ...
                                                        <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UserId") %>' CausesValidation="False" ID="Linkbutton2">
                                                                                                ...
                                                                                                <asp:TemplateColumn HeaderText="操作员名称">
													<ItemTemplate>
														<%--<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UserName") %>' CausesValidation="False" ID="Linkbutton2">--%>
                                                        <asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UserName") %>' CausesValidation="False" ID="Linkbutton2">
														</asp:Label>
												...
												<asp:TemplateColumn HeaderText="操作类型">
													<ItemTemplate>
