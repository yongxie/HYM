						...
						<td>
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
								<tr>
									...
									<td class="title2" nowrap>会员信息查询浏览</td>
									<td width="10"><img height="25" src="../../images/page/table_tit_r2.gif" width="10"></td>

									<td class="tdimages" width="99%" align="right">

                                    会员卡号：<asp:TextBox id="txtCardId" runat="server" Width="100px" >&nbsp;&nbsp;</asp:TextBox>&nbsp;&nbsp;
                                    会员姓名：<asp:TextBox id="txtMemName" runat="server" Width="100px" >&nbsp;&nbsp;</asp:TextBox>&nbsp;&nbsp;
                                    所属部门：<asp:DropDownList id="ddlMemID" runat="server" DESIGNTIMEDRAGDROP="70"></asp:DropDownList>&nbsp;&nbsp;
								...
								<tr>
									<td><asp:datagrid id="MyDataGrid" runat="server" gridlines="Horizontal" 
											...
											<Columns >
                                                ...
                                                <asp:TemplateColumn HeaderText="卡状态">
													<ItemTemplate>
