<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="System_SMSLog_View.aspx.cs" Inherits="Web.main_system.program.System_SMSLog_View" %>

<HTML>
	<HEAD>
		<title>系统功能_短信发送日志查询</title>
		<%--/* ＊＊＊＊＊程序信息注释＊＊＊＊＊＊＊＊
          程序名：系统功能_短信发送日志查询程序
          程序描述：系统功能短信发送日志查询程序
         ＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊*/--%>
						...
						<td>
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
								<tr>
									...
									<td class="title2" nowrap>短信发送查询浏览</td>
									<td width="10"><img height="25" src="../../images/page/table_tit_r2.gif" width="10"></td>
									<td class="tdimages" width="99%" align="right">手机号码：<asp:TextBox id="txtNum" runat="server" ></asp:TextBox>
								...
								<tr>
									<td><asp:datagrid id="MyDataGrid" runat="server" gridlines="Horizontal" 
											...
											<Columns>
                                                ...
                                                <asp:TemplateColumn Visible="false" HeaderText="短信代码">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MsgId") %>' CausesValidation="False" ID="Linkbutton2">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="手机号码">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DirNum") %>' CausesValidation="False" ID="Linkbutton1">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="短信内容">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Msg").ToString()+"......" %>' CausesValidation="False" ID="Label1">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="记录发送时间">
													<ItemTemplate>
														<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SendTime") %>' CausesValidation="False" ID="Label2">
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
											    <asp:HyperLinkColumn DataNavigateUrlField="MsgId" 
                                                    DataNavigateUrlFormatString="javascript:varwin=window.open('detail.aspx?MsgId={0}',null,'width=600,height=300');window.Close(); " 
                                                    Text="详细">
